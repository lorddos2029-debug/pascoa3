document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        {
            question: "Qual seu tipo de Ovo de Páscoa favorito?",
            options: [
                { text: "Clássico ao Leite" },
                { text: "Trufado Recheado" },
                { text: "Gourmet Crocante" },
                { text: "Linha Infantil" }
            ]
        },
        {
            question: "Qual linha da Cacau Show você mais ama?",
            options: [
                { text: "LaCreme (Derrete na boca)" },
                { text: "Dreams (Muito Recheio)" },
                { text: "Bendito Cacao (Intenso)" },
                { text: "Gelato (Sorvetes)" }
            ]
        },
        {
            question: "Para quem você vai comprar chocolate hoje?",
            options: [
                { text: "Para mim mesmo(a)" },
                { text: "Família" },
                { text: "Namorado(a)" },
                { text: "Amigos" }
            ]
        ...
        {
            question: "Qual recheio é indispensável para você?",
            options: [
                { text: "Brigadeiro Cremoso" },
                { text: "Avelã / Nutella" },
                { text: "Doce de Leite" },
                { text: "Cereja ao Licor" }
            ]
        },
        {
            question: "Qual formato de chocolate você prefere?",
            options: [
                { text: "Barra Tradicional" },
                { text: "Bombons e Trufas" },
                { text: "Drageados" },
                { text: "Chocolate Quente" }
            ]
        },
        {
            question: "O que você mais valoriza na Cacau Show?",
            options: [
                { text: "Qualidade do Chocolate" },
                { text: "Embalagens Lindas" },
